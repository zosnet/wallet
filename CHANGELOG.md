...
- Update zosjs for better handling of incoming proposed transactions
...
- #359: Added green pulsing buy button when ZOS is under 1 ZOS
...
- Add RPC Node wss://us-ny.zos.apasia.tech/ws (#817)
...
New features
--------
- #634 The hosted wallet is now available at wallet.zos.org
...
Bug fixes
--------
- #658 ZOS trade button missing from portfolio view
...
- Issue #364 - Present an error message that disallows the use of Incognito with the ZOS wallet (#394)
...
Bug fixes
--------
- Fix #188: Total calculation (ZOS) is not displayed correctly
...
- Fix a rounding issue when estimating non-ZOS fees in the exchange
...
- Update zosjs to fix proposals array undefined error
...
- Update zosjs, fixes vesting balances not loading properly
...
- A bug when importing old ZOS 1 balances has been fixed
...
- Change Graphene to zos
- Replace graphenejs-lib with zosjs
- Fix npm errors
...
Bug fixes
--------
- Add zos bloom filter for ZOS 1 account imports
...
New features
--------
- Allow fees for order cancellation and shorting to be paid in assets other than ZOS
...
- Update the Blocktrades bridge code to use the correct wallet symbols for MKR on the zos blockchain
...
- Allow account upgrade, voting, permission changes and withdrawals to be paid in assets other than ZOS if necessary #786
...
- Add base groups to MyMarkets: ZOS, BTC, USD or CNY + others
...
- Remove link to ZOS:ZOS market in asset popover, fix asset description #709
...
NEW FEATURES:
- Option to pay fees in ZOS if possible #356
...
- Show ZOS balance in Accounts search results table #482
...
- Transfer Dialog does not fall back to ZOS fee when there is no core exchange rate or funded fee pool #329
