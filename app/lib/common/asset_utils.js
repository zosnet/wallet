...
export default class AssetUtils {
    ...
    static getAssetProperty(uasset_property) {
        let propertys = {
            asset_cash: false,
            asset_lender: false,
            asset_loan: false,
        ...
        assetConstants.uasset_property_mask.map(property => {
            if (uasset_property & assetConstants.asset_property[property]) {
    ...
    static getAssetConstantsProperty() {
        return assetConstants.asset_property;
    }
}
