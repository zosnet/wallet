...
import {Signature, ChainStore, PublicKey} from "zosjs/es";
import WalletUnlockActions from "actions/WalletUnlockActions";
import WalletDb from "stores/WalletDb";

const MSG_HEAD = "-----BEGIN zos SIGNED MESSAGE-----";
const MSG_META = "-----BEGIN META-----";
const MSG_SIGNATURE = "-----BEGIN SIGNATURE-----";
const MSG_FOOT = "-----END zos SIGNED MESSAGE-----";
...
class SignedMessageAction {
     ...
     *                      block : Current last irreversible block of the zos blockchain
