...
class DepositModalContent extends DecimalChecker {
        ...
        this.state = {
            ...
            gatewayStatus: {
                OPEN: {
                    ...
                    selected: false,
                    support_url:
                        "https://wallet.zos.org/#/help/gateways/openledger"
                },
                RUDEX: {
                    id: "RUDEX",
                    name: "RUDEX",
                    enabled: false,
                    selected: false,
                    support_url: "https://wallet.zos.org/#/help/gateways/rudex"
                }
            }
        };
    ...
    componentWillMount() {
        ...
        if (usingGateway) {
            ...
            this.setState({selectedAsset: "ZOS"});
        }
    }
    ...
    render() {
        ...
        if (selectedGateway == null && selectedAsset == "ZOS") {
            usingGateway = false;
