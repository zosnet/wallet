...
class ProposalDeleteModal extends React.Component {
    static propTypes = {
    ...
    _onProposalAction(oldProposal) {
        ...
        if (!payee && !active) {
            console.log("need fee_paying_account");
            return false;
        }
        ...
        tr.add_type_operation("proposal_delete", proposal);
    ...
    render() {
        ...
        if (
            ...
            this.onChangePayee(myAccounts[0]);
        }
                ...
                <div className="grid-container">
                    ...
                    <div className="content-block full-width-content">
                        <div className="full-width-content form-group">
                            ...
                            {passwordLogin ? (
                                <span>
                                    {myAccounts.length ? myAccounts[0] : ""}
                                </span>
                            ) : (
                                <AccountSelect
                            ...
                            value={
                                isAdd
                                    ? counterpart.translate(
                                          "modal.proposals.approve"
                                      )
                                    : counterpart.translate(
                                          "modal.proposals.remove"
                                      )
                            }
                        />
                        <div
...
ProposalDeleteModal = BindToChainState(ProposalDeleteModal);
