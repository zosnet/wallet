                    ...
                    <div className="card-content">
                        ...
                        <table className="table key-value-table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Recent Missed</td>
                                    <td>{witness_data.get("recent_missed")}</td>
                                </tr>
                                <tr>
                                    <td>Missed</td>
...
class WitnessRow extends React.Component {
    ...
    render() {
        ...
        let recentmissed = witness_data.get("recent_missed");
        ...
        return (
            <tr className={currentClass} onClick={this._onRowClick.bind(this)}>
                ...
                <td className={missedClass}>{recentmissed}</td>
                ...
                <table className="table table-hover">
                    <thead>
                        <tr>
                            ...
                            >
                                <Translate content="explorer.witnesses.recent_missed" />
                            </th>
                            <th
                                className="clickable"
                                onClick={this._setSort.bind(
...
class Witnesses extends React.Component {
    ...
    _getBlockSummary() {
        ChainStore.getBlockSummary()
            .then(res_sum => {
                if (res_sum !== undefined) {
                    this.setState({blockSummary: res_sum});
                }
            })
            .catch(err => {
    ...
    componentWillMount() {
        this._getBlockSummary.call(this);
    }
            ...
            >
                ...
                >
                    <div className="grid-block zos-filter">
                        <Translate
                            className="title"
                            content="explorer.witnesses.filter_title"
                        />
                        <input
                            type="text"
                    ...
                    <div className="grid-block">
                        <div className="grid-block vertical small-5 medium-3">
                            ...
                            >
                                <table className="table" id="witness-info">
                                    <tbody>
                                        <tr>
                                            <td className="no-padding-right">
                                        ...
                                        <tr>
                                            <td className="no-padding-right">
                                                <Translate content="explorer.witnesses.miner_payed" />
                                            </td>
                                            <td>
                                                {" "}
                                                {blockSummary ? (
