...
class Settings extends React.Component {
        ...
        this.state = {
            ...
            settingEntries: {
                general: [
                    "locale",
                    "unit",
                    "browser_notifications", //是否在深度图中显示清算订单
                    /*"showSettles",*/ "walletLockTimeout",
                    "themes",
                    "showAssetPercent",
                    "passwordLogin",
                    "reset"
    ...
    _getMenuEntries(props) {
        ...
        menuEntries.push("faucet_address");
    ...
    _onChangeSetting(setting, e) {
        ...
        switch (setting) {
            ...
            case "confirmMarketOrder":
                value = findEntry(e.target.value, defaults[setting]) === 0; // USD/ZOS is true, ZOS/USD is false
                break;
    ...
    render() {
        ...
        return (
            <div className={this.props.deprecated ? "" : "grid-block"}>
                <div
                    className="grid-block main-content margin-block wrap zos-fixed-tabs"
                    style={{display: "block"}}
                >
                    <div className="account-tabs">
                        <div className="service-selector">
                            <ul className="button-group no-margin account-overview bordered-header content-block">
                                {/*
                                <li><a><span className="tab-title"> 区块链 </span></a></li>
                                <li><a><span className="tab-title"> 资产 </span></a></li>
                                <li><a><span className="tab-title"> 账户 </span></a></li>
                                */}
