...
class AccountVoting extends React.Component {
    static propTypes = {
        ...
        dGlobalObject: ChainTypes.ChainObject.isRequired,
    ...
    render() {
        ...
        let {globalObject, dGlobalObject} = this.props;
        let budgetObject;
        ...
        let totalBudget = 0;
        // let unusedBudget = 0;
        let workerBudget = dGlobalObject
            ? parseInt(dGlobalObject.getIn(["worker_budget"]), 10)
            : 0;
