...
class AccountAssetUpdate extends React.Component {
    ...
    _onCoreRateChange(type, amount) {
        amount.amount = amount.amount.replace(/,/g, "");
                ...
                <div className="tabs-container generic-bordered-box zos-fixed-tabs">
                    ...
                    <div>
                        ...
                        >
                            ...
                            {/*<Tab title="explorer.asset.fee_pool.title">  //屏蔽书续费资金池
                                <div className="small-12 large-8 large-offset-2 grid-content">
                                     Fund fee pool
                                    <Translate
                                        component="p"
                                    ...
                                    <AmountSelector
                                        ...
                                        onChange={this._onPoolInput.bind(
                                            this
                                        )}
                                        asset={"1.3.0"}
                                        assets={["1.3.0"]}
