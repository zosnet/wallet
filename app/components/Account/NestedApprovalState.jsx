        ...
        status.push(
            ...
            >
                ...
                <div
                    ...
                    style={{
                        paddingLeft: showCrossIcon ? 10 : 0,
                        marginRight: showCrossIcon ? 10 : 0
                    }}
                >
                    {!isNested && !isMultiSig ? (
                        <span>
                            {isOK ? (
                                ...
                                <Translate content="proposal.not_approve" />
                            )}
                        </span>
                    ) : (
...
class FirstLevel extends React.Component {
    ...
    render() {
        let {type, added, removed, availableKeys, showCrossIcon} = this.props;
...
class ProposalWrapper extends React.Component {
    static propTypes = {
        proposalHistory: ChainTypes.ChainHistoryObject,
        proposal: ChainTypes.ChainObject,
    ...
    render() {
        let {type, showCrossIcon} = this.props;
        let proposal = null;
        if (this.props.proposal) {
            proposal = this.props.proposal;
        }
        if (this.props.proposalHistory) {
            proposal = this.props.proposalHistory;
        }
        if (!proposal) {
            return null;
        }
