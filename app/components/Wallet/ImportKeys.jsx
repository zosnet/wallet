...
import {PrivateKey, Aes, PublicKey, hash} from "zosjs/es";
import {ChainConfig} from "zosjs-ws";
...
class ImportKeys extends Component {
    ...
    /** ZOS 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // ZOS 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    /**
    ZOS 1.0 hosted wallet backup (wallet.zos.org) is supported.

    ZOS 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function(pubkey, account_name) {
            ...
            address = "ZOS" + address.substring(3);
        ...
        try {
            ...
            if (!encrypted_brainkey)
                throw "Please use a ZOS 1.0 wallet_export_keys file instead";
