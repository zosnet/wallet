...
class TransactionConfirm extends React.Component {
    ...
    render() {
        ...
        if (this.props.error || this.props.included) {
            ...
            button_group = (
                <div className="button-group">
                    <div className="grid-block full-width-content button-group">
                        <div
        ...
        let hidePropose = false;
        if (
            this.props.transaction &&
            this.props.transaction.operations &&
            this.props.transaction.operations[0]
        ) {
            let chainOperationType = parseInt(
                this.props.transaction.operations[0],
                10
            );
            // proposal_create: 22, 创建包含一个提案
            // proposal_update: 23,
            // proposal_delete: 24,
            if ([23, 24].indexOf(chainOperationType) >= 0) {
                hidePropose = true;
            }
        }
            ...
            <div ref="transactionConfirm">
                ...
                >
                    ...
                    >
                        ...
                        {this.props.propose ? (
                            <div
                                className="grid-content full-width-content form-group"
