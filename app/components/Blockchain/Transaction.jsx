...
class Transaction extends React.Component {
    ...
    render() {
        ...
        trx.operations.forEach((op, opIndex) => {
            ...
            let color = "";
            switch (
                opers[op[0]] // For a list of trx types, see chain_types.coffee
            ) {
                case "transfer":
                    color = "success";
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.carriers.website"
                                />
                            </td>
                            <td>{op[1].url}</td>
                        </tr>
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.gateways.website"
                                />
                            </td>
                            <td>{op[1].url}</td>
                        </tr>
                ...
                case "gateway_withdraw":
                    ...
                    rows.push(
                        <tr key={key++}>
                            ...
                            <td>
                                <FormattedAsset
                                    amount={op[1].withdraw.amount}
                                    asset={op[1].withdraw.asset_id}
                                />
                            </td>
                        </tr>
                    );
                ...
                case "gateway_deposit":
                    ...
                    rows.push(
                        <tr key={key++}>
                            ...
                            <td>
                                <FormattedAsset
                                    amount={op[1].deposit.amount}
                                    asset={op[1].deposit.asset_id}
                                />
                            </td>
                        </tr>
                    );
