...
class Header extends React.Component {
    ...
    render() {
        ...
        const enableDepositWithdraw =
            Apis.instance().chain_id.substr(0, 8) === "6202d610";
        ...
        const bizPlatform = (
            <ActionSheet>
                <ActionSheet.Button title="">
                    <Translate content="header.biz_platfrom" />
                </ActionSheet.Button>
                <ActionSheet.Content>
                    <ul className="no-first-element-top-border">
                        <li>
                            <a href="https://lending.zos.io" target="_blank">
                                <Translate content="header.biz_lengding" />
                            </a>
                        </li>
                        <li>
                            <a href="https://www.zos.io" target="_blank">
                                <Translate content="header.biz_dashboard" />
                            </a>
                        </li>
                    </ul>
                </ActionSheet.Content>
        ...
        return (
            <div className="header-container" style={{minHeight: "70px"}}>
                <div className="zos-container">
                    ...
                    {/*{currentAccount == null ? null :   //没有登录不显示锁
                        (<div>
                            <span
                    ...
                    <div className="right-meunbar">
                        <span style={{padding: "0 1rem"}}>{bizPlatform}</span>
                        <span onClick={this._toggleLock.bind(this)}>
                            <Translate
                                content={`header.${
                                    this.props.locked ? "login" : "logout"
                                }`}
                            />
                        </span>
                        <span> | </span>
                        ...
                        >
                            <Translate content="header.register" />
                        </span>
                    </div>
                                ...
                                >
                                    ...
                                    {currentAccount == null ? null : (
                                        ...
                                        >
                                            ...
                                            <div className="table-cell">
                                                <Translate content="header.create_worker" />
                                            </div>
                                        </li>
                                    )}
                                    {currentAccount == null ? null : (
