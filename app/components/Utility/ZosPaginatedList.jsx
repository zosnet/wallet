...
import ZosPagination from "./ZosPagination";
import TransitionWrapper from "./TransitionWrapper";

require("./zos_paginated_list.scss");

// Copy and modify base antd@3.8.0.pagination
// 无法安装 antd@3.8.0
// zilla<illa914gmail.com>
export default class ZosPaginatedList extends React.Component {
    constructor(props) {
        super(props);
