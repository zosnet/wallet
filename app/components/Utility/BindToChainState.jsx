...
const isHistoryObjectType = checkChainType(ChainTypes.ChainHistoryObject);
    ...
    class Wrapper extends React.Component {
        constructor(props) {
            ...
            if (options && options.all_props) {
                ...
                this.chain_history_objects = this.chain_objects;
                this.chain_accounts = [];
                ...
                this.chain_objects = prop_types_array
                    ...
                    .map(firstEl);
                this.chain_history_objects = prop_types_array
                    .filter(
                        flow(
                            secondEl,
                            isHistoryObjectType
        ...
        update(next_props = null) {
            ...
            for (let key of this.chain_history_objects) {
                let prop =
                    props[key] ||
                    this.dynamic_props[key] ||
                    this.default_props[key];
