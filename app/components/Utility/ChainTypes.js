...
import {ChainTypes as grapheneChainTypes, ChainValidation} from "zosjs/es";
...
let ChainHistoryObject = createChainableTypeChecker(objectIdChecker); //新增历史对象,从 get_object_history 中获取
