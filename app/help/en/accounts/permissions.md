...
In zos, each account is separated into
...
In zos an *authority* consists of one or many entities that authorize an
...
must sign in order for the transaction to be valid. Now, in zos, we have
