...
tarif etmektedir. Fakat fiilen bir  ekosisteme dönüşmesi  zos gibi
gerçek bir blokzinciri ile birlikte mümkün olur.

zos , blokzinciri yeniliğini , hizmetlerini internet kullanarak sunan tüm
...
Bitcoin para için ne yaptıysa zos'de işletmeler için onu yapar. Bunu , evrensel,
şeffaf, güvenilir, verimli ve karlı şirketler yaratmak için dağıtık mutabakat teknolojisini 
kullanarak yapar.

## Bu Cüzdan

Şu an bu tarayıcı penceresinde açık olan cüzdanla zos ağının tüm işlevlerine
erişebilirsiniz.
